...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('<?=base_url();?>login/images/img-01.jpg');">
			<div class="wrap-login100 p-t-190 p-b-30">
				<form class="login100-form validate-form" action='<?=site_url("/auth");?>' method='post' name='process'>

					<div class="login100-form-avatar">
						<img src="<?=base_url();?>login/images/avatar-01.jpg" alt="AVATAR">
					</div>
